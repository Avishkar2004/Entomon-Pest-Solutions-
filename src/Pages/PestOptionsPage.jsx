  ...
  return (
    <div className="min-h-screen mb-[12rem] sm:mt-[4rem] lg:mt-[3rem] xl:mt-15 ssm:mt-[4rem] md:mt-[1rem] flex items-center justify-center">
      ...
      <div className="p-8 ml-[-12px] w-[70rem] rounded-lg shadow-xl xl:-mt-[20rem] sm:-mt-[8rem] ssm:-mt-[11rem] md:-mt-[12rem] lg:-mt-[12rem] bg-white">
        <h1
          className="text-3xl font-semibold mb-5 text-center items-center text-green-500"
        >
          Our Pest Control Services
        </h1>

        <div className="grid grid-cols-1 xsm:grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-8 ml-12 items-center">
          {/* Termite Control */}
          <div
