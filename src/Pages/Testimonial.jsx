...
const Testimonial = () => {
  return (
    <div className="container items-center md:mt-[5rem] xl:mt-[12rem] xxl:mt-[-27rem] lg:mt-[-10rem] sm:mt-12 ssm:-mt-[18rem] xsm:mt-[-9rem] my-24 mx-auto md:px-6">
        ...
        <div className="grid gap-6 md:grid-cols-3 xl:gap-x-12">
          ...
          <div className="mb-6 lg:mb-0">
            <div className="relative block rounded-2xl bg-red-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
              <div className="flex"></div>
              <div className="p-6 ">
                <h5 className="mb-2 text-lg font-bold" data-aos="zoom-in"
                  data-aos-delay="1000">Gayatri Shirsath</h5>
                <h6 className="mb-4 font-medium text-primary dark:text-primary-400">
                  Local Guide
                </h6>
                <ul className="mb-6 flex justify-center">
